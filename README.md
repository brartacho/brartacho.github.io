...
- imagem social configurada para compartilhamento: `imagens/capa-portfolio-whatsapp-balanced.jpg`
...
- `og:image` e `twitter:image` usando `imagens/capa-portfolio-whatsapp-balanced.jpg`
...
- Para a prévia social funcionar corretamente, `imagens/capa-portfolio-whatsapp-balanced.jpg` precisa estar publicada nesse mesmo caminho no domínio final.
