...
- imagem social configurada para compartilhamento: `imagens/capa-portfolio-ok-meta.jpg`
...
- `og:image` e `twitter:image` usando `imagens/capa-portfolio-ok-meta.jpg`
...
- Para a prévia social funcionar corretamente, `imagens/capa-portfolio-ok-meta.jpg` precisa estar publicada nesse mesmo caminho no domínio final.
