...
- imagem social configurada para compartilhamento: `imagens/capa-portfolio-whatsapp-safe.jpg`
...
- `og:image` e `twitter:image` usando `imagens/capa-portfolio-whatsapp-safe.jpg`
...
- Para a prévia social funcionar corretamente, `imagens/capa-portfolio-whatsapp-safe.jpg` precisa estar publicada nesse mesmo caminho no domínio final.
