...
- imagem social configurada para compartilhamento: `imagens/capa-portfolio-whatsapp-square-safe.jpg`
...
- `og:image` e `twitter:image` usando `imagens/capa-portfolio-whatsapp-square-safe.jpg`
...
- Para a prévia social funcionar corretamente, `imagens/capa-portfolio-whatsapp-square-safe.jpg` precisa estar publicada nesse mesmo caminho no domínio final.
