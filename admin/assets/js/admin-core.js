...
const QUICK_SEARCH_DEFAULTS = [
    ...
    { id: 'posts_estamos_contratando', label: 'Publicações: "estamos contratando"', icon: 'fa-megaphone', url_template: 'https://www.linkedin.com/search/results/content/?keywords=%22estamos%20contratando%22%20{kw}', enabled: true },
    ...
    { id: 'people_recrutadores', label: 'Recrutadores de TI', icon: 'fa-address-card', url_template: 'https://www.linkedin.com/search/results/people/?keywords=%22Recrutador%22%20OR%20%22Recruiter%22%20OR%20%22Talent%20Acquisition%22%20TI%20OR%20tecnologia', enabled: true },
    ...
    { id: 'boolean_qa_cypress', label: 'Boolean: QA + Cypress', icon: 'fa-vial', url_template: 'https://www.linkedin.com/jobs/search/?keywords=%28%22QA%22%20OR%20%22Analista%20de%20Testes%22%29%20AND%20%22Cypress%22&f_TPR=r604800&sortBy=DD', enabled: true },
    { id: 'boolean_qa_api', label: 'Boolean: QA + API', icon: 'fa-plug', url_template: 'https://www.linkedin.com/jobs/search/?keywords=%22QA%22%20AND%20%28%22API%22%20OR%20%22Postman%22%20OR%20%22REST%22%29&f_TPR=r604800&sortBy=DD', enabled: true },
...
const QUICK_SEARCH_ICONS = ['fa-clock','fa-calendar-week','fa-bullhorn','fa-megaphone','fa-eye','fa-user-tie','fa-address-card','fa-code','fa-vial','fa-plug','fa-robot','fa-magnifying-glass','fa-briefcase','fa-building','fa-link','fa-star'];
